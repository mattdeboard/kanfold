...
goog.addDependency("../kanfold/core.js", ['kanfold.core'], ['om_tools.dom', 'om_bootstrap.grid', 'clojure.browser.repl', 'cljs.core', 'om_bootstrap.panel', 'om.dom', 'cljs.core.async', 'figwheel.client', 'om.core', 'om_bootstrap.random']);